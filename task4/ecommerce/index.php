...
$products = $productobject->newproduct()->fetch_all(MYSQLI_ASSOC);
?>
<!-- Slider Start -->
        ...
        <div class="tab-content jump">
            <div class="tab-pane active">
                ...
                <?php foreach($products AS $product) { ?>
                    <div class="product-wrapper-single my-3">
                        ...
                        <div class="product-wrapper mb-30">
                            <div class="product-img">
                                <a href="product-details.php">
                                    <img alt="" src="assets/img/product/<?= $product['image'] ?>" style="width:280px ;height:300px;">
                                </a>
