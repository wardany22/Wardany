    ...
    if(isset($_GET['brand'])){
        if(is_numeric($_GET['brand'])){
            ...
            if($brandsResult->num_rows == 1){
                ...
                $products = $productObject->getProductsByBrand()->fetch_all(MYSQLI_ASSOC);
            }else{
        ...
        if(is_numeric($_GET['category'])){
            ...
            $categoriesResult = $category->setId($_GET['category'])->getCategory();
            if($categoriesResult->num_rows == 1){
                $productObject->setCategory_id($_GET['category']);
                $products = $productObject->getProductsByCategory()->fetch_all(MYSQLI_ASSOC);
            }else{
                header("location:layouts/errors/404.php") ;die;
            }
        }else{
        ...
        if(is_numeric($_GET['subcategory'])){
            ...
            if($subcategoriesResult->num_rows == 1){
                ...
                $products = $productObject->getProductsBySubcategory()->fetch_all(MYSQLI_ASSOC);
            }else{
                header("location:layouts/errors/404.php") ;die;
            }
        }else{
